...
#define STRING_CONFIG_H_AUTHOR "(mcnanney, Ender-5)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 96.1 }
 ...
 *     |    [-]    |
 *     O-- FRONT --+ X-54.00 Y-27.00 Z-2.64
 */
#define NOZZLE_TO_PROBE_OFFSET { -54.00, -27.00, -2.64 }
